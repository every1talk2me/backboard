 ...
 */
class HexagonImpl<SatelliteData> internal constructor(
        private val sharedData: GridData,
        override val cubeCoordinate: CubeCoordinate,
        private val hexagonDataStorage: HexagonDataStorage<SatelliteData>) : Hexagon<SatelliteData> {
    ...
    override val satelliteData: SatelliteData
    ...
    override fun setSatelliteData(data: SatelliteData) {
