 ...
 *
 */
interface HexagonalGrid<SatelliteData> {
     ...
     * @return hexagons
     */
    val hexagons: Iterable<Hexagon<SatelliteData>>
     ...
     */
    fun getHexagonsByCubeRange(from: CubeCoordinate, to: CubeCoordinate): Iterable<Hexagon<SatelliteData>>
     ...
     * @return [Hexagon]s in the given range.
     */
    fun getHexagonsByOffsetRange(gridXFrom: Int, gridXTo: Int, gridYFrom: Int, gridYTo: Int): Iterable<Hexagon<SatelliteData>>
     ...
     */
    fun getByCubeCoordinate(coordinate: CubeCoordinate): Hexagon<SatelliteData>
     ...
     * @return Maybe with a Hexagon if it is present
     */
    fun getByPixelCoordinate(coordinateX: Double, coordinateY: Double): Hexagon<SatelliteData>
     ...
     */
    fun getNeighborByIndex(hexagon: Hexagon<SatelliteData>, index: Int): Hexagon<SatelliteData>
     ...
     */
    fun getNeighborsOf(hexagon: Hexagon<SatelliteData>): Collection<Hexagon<SatelliteData>>
