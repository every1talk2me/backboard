 ...
 */
interface HexagonDataStorage<SatelliteData> {
     ...
     */
    fun addCoordinate(cubeCoordinate: CubeCoordinate, satelliteData: SatelliteData): Boolean
     ...
     */
    fun getSatelliteDataBy(cubeCoordinate: CubeCoordinate): SatelliteData
